...
> **R:**porque en etapa procesamiento, los comentarios no existen
...
> **R:** grep -n "1.0\|CUADRADO" programa.i
...
> **R:**proviene de "C:/msys64/ucrt64/include/stdio.h"
...
> **R:**12:sumar:
        36:     .ascii "sumar(3, 4)       = %d\12\0"
        48:     .ascii "Llamadas a sumar(): %d\12\0"
        70:     call    sumar
...
> **R:**porque en programa.o no esta definida y en matematica.o si esta definida su implementacion completa
...
> **R:**no se puede ejecutar porque es un archivo binario
...
> **R:**porque son funciones de la biblioteca denamica del sistema, no se copian dentro del ejecutable
...
> **R:**macro funcion: es expandida por el procesador antes que el compilador, desaparece en la etapa de preprocesamiento y macro real: es compilada y desaparece en la etapa de enlazado
...
> **R:**simbolo T esta en la seccion de .txt y D esta en la seccion de .data
...
> **R:**$ ldd programa.exe 
> ntdll.dll => /c/Windows/SYSTEM32/ntdll.dll (0x7ffe69850000)
> KERNEL32.DLL => /c/Windows/System32/KERNEL32.DLL (0x7ffe68c60000)
> KERNELBASE.dll => /c/Windows/System32/KERNELBASE.dll (0x7ffe67240000)
> ucrtbase.dll => /c/Windows/System32/ucrtbase.dll (0x7ffe66ee0000)
